...
*Description:* List of papers on earth observation, causal inference, machine learning, and/or poverty research compiled by [Kaz Sakamoto](https://github.com/ksakamoto09) for a systematic literature review in collaboration with [Connor T. Jerzak](https://github.com/cjerzak) and [Adel Daoud](http://adeldaoud.se/). To find associated `.bib` entries, see [`eo-poverty-review/citations`](https://github.com/AIandGlobalDevelopmentLab/eo-poverty-review/tree/main/citations). 
